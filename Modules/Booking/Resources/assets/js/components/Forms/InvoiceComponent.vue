    ...
    <div class="offcanvas-body">
      ...
      <div v-if="bookingData.products !=null" class="form-group border-top ">
        <div v-for="(product, index) in bookingData.products" :key="index" class="py-2">
          <div class="d-flex flex-column gap-1">
            <div class="d-flex align-items-center justify-content-between">
              <h6 class="me-3 w-80 mb-0">{{ product.product_name }} (<strong>{{ product.product_qty }}</strong>)</h6>
              <div class="d-flex ">
      ...
      <div class="border-top border-bottom py-3">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <span><strong>{{ formatCurrencyVue(productTotal) }}</strong></span>
        </div>
...
const calculatePercentAmount = (percent) => {
  ...
  const percentAmount = ((servicesTotal.value +productTotal.value) * percent) / 100;
...
const taxAmount = computed(() => {
  ...
  if(bookingTransaction.value !== null) {
      ...
      if (tax.type === 'percent') {
        totalTaxAmount += ((servicesTotal.value +productTotal.value) * tax.percent) / 100;
      } else {

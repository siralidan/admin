        ...
        <tbody>
          <tr v-for="(currency, index) in tableList" :key="index">
            ...
            <th>
              ...
              <button type="button" class="btn btn-soft-danger btn-sm" @click="destroyData(currency.id, 'Are you sure you want to delete it?')" data-bs-toggle="tooltip"><i class="fa-solid fa-trash"></i></button>
            </th>
          </tr>
        </tbody>
      </template>
